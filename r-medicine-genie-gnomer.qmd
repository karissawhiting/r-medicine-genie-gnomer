...
-   However, if patients only have one report, it will be returned regardless
:::
...
## Not All Patients Tested on Same Panel {.scrollable}
...
-   You can use any {gtsummary} functions on top of `tbl_genomic()` to customize table
...
![](images/pathways.png){.absolute bottom="100" left="100" width="400px"}
